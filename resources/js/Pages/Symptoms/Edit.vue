...
const submit = () => {
  form.put(route('symptoms.update', props.symptom.id), {
    preserveScroll: true,
...
<template>
  <Head title="Edit Symptoms" />

  <AuthenticatedLayout>
    <template #header>
      <h2 class="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-200">Edit Symptoms</h2>
      <Breadcrumbs
        :current_name="'Edit Symptoms'"
